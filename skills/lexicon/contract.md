...
The only supported semantic schema is `3.2`. Read `MODEL.md` for XML syntax. Start from the question; add domain meaning, software structure, or a runtime scenario only when it helps answer it. Use Explain / Initialize / Refine for semantic work; Operate addresses connected viewer state and navigation.
