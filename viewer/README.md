...
- **Reading code:** a code node opens source and all its domain mappings. A code connector opens its specific mapping and source. Targets are grouped by their declared paths and symbols; aliases are not resolved into canonical identities.
