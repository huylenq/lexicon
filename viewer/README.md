...
- **Explore:** search highlights matches while retaining the overall picture. **Locate** reveals and centers a selection. **Focus** in the right-click menu shows its immediate neighborhood; **Back to overview** restores the previous camera. Click empty graph space, choose **Clear selection**, or press Escape within the graph to deselect without moving the camera.
