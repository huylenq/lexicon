...
**Linked Sources** renders only authored source-link targets, grouped into file cards. It does not scan the filesystem or require a separate source index. Potentially stale links remain visible. Its saved page and drawing identities are shared between 2D and Planes.
