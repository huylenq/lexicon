...
Exclude the project-root lexicon/ directory from source discovery and new source evidence by default: it contains Lexicon model and presentation artifacts. Read those artifacts as needed to understand, refine, or migrate the existing model, not as independent evidence about the implementation. An explicit user request to inspect or use a document there overrides this discovery default.
